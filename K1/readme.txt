...
Theme URI: 	Author: Karen Attfield
...
If you install a plugin and encounter issues after trying it, ask the plugin author for support first. If the plugin author says that itâ€™s a problems with the theme, please contact the theme author via github:
== SHORTCODES ==
